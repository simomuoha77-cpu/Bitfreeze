...
const WITHDRAW_BOT = new TelegramBot(process.env.TELEGRAM_WITHDRAW_BOT_TOKEN, { polling: false });
...
app.post('/api/deposit', auth, async (req, res) => {
  ...
  DEPOSIT_BOT.sendMessage(TELEGRAM_CHAT_ID,
...
app.post('/api/withdraw', auth, async (req, res) => {
  ...
  WITHDRAW_BOT.sendMessage(TELEGRAM_CHAT_ID,
