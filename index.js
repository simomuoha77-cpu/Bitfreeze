...
// Fridges
const FRIDGES = [
  { id: '2ft', name: '2 ft Fridge', price: 500, dailyEarn: 25, img: 'https://bitfreeze-production.up.railway.app/images/fridge2ft.jpg' },
  { id: '4ft', name: '4 ft Fridge', price: 1000, dailyEarn: 55, img: 'https://bitfreeze-production.up.railway.app/images/fridge4ft.jpg' },
  { id: '6ft', name: '6 ft Fridge', price: 2000, dailyEarn: 100, img: 'https://bitfreeze-production.up.railway.app/images/fridge6ft.jpg' },
  { id: '8ft', name: '8 ft Fridge', price: 4000, dailyEarn: 150, img: 'https://bitfreeze-production.up.railway.app/images/fridge8ft.jpg' },
  { id: '10ft', name: '10 ft Fridge', price: 6000, dailyEarn: 250, img: 'https://bitfreeze-production.up.railway.app/images/fridge10ft.jpg' },
  { id: '12ft', name: '12 ft Fridge', price: 8000, dailyEarn: 350, img: 'https://bitfreeze-production.up.railway.app/images/fridge12ft.jpg' },
];
...
app.post('/api/register', async (req,res)=>{
  ...
  res.json({
    message:'Registered! 200 KES bonus added (cannot withdraw until deposit ≥ 500)',
    token,
    email:user.email
  });
});
...
app.post('/api/deposit', auth, async(req,res)=>{
  ...
  if(!ALLOWED_DEPOSITS.includes(Number(amount))) return res.status(400).json({ error:`Deposit the exact fridge amount: 500,1000,2000,4000,6000,8000 KES` });
...
app.post('/api/withdraw', auth, async(req,res)=>{
  ...
  const depositsSum = u.fridges.reduce((acc,f)=>acc+(f.price||0),0);
  const withdrawable = u.balance - depositsSum;
  if(withdrawable < Number(amount)) return res.status(400).json({ error:'Insufficient withdrawable balance. You can only withdraw earnings + unlocked bonus, not your deposits.' });
